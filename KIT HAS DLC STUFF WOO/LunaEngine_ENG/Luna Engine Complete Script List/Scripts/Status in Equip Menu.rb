...
$imported["YEL-MenuLuna-StatusEquipMenu"] = true
...
#==============================================================================
#==============================================================================
# ■ Spriteset_EquipStatus
#==============================================================================

class Spriteset_EquipStatus < Spriteset_MenuStatus
  ...
  #--------------------------------------------------------------------------
  def setting
    MenuLuna::EquipMenu::CURRENT_ACTOR_STATUS
  end
...
class Scene_Equip < Scene_MenuBase
  ...
  def create_status_sprite
    @current_status = Spriteset_EquipStatus.new(@viewport, @actor)
