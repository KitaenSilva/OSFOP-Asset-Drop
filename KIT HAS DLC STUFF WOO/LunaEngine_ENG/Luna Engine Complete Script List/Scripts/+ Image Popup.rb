#==============================================================================
# ■ BattleLuna: Damage Popup Image Add-On
# =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
# This is an extension for Damage Popup. This uses Image sheets rather than 
# using the game's font. The sheets are arranged horizontally.
#==============================================================================
...
module BattleLuna
  module Addon
    ...
    BATTLE_POPUP[:image_setup] = {
      ...
      # This will create default text if it cannot find an image.
      # For example:
